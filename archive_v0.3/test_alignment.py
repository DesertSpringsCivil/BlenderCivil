...
def create_test_pis():
    ...
    print(f"âœ“ Created {len(pis)} test PI points")
    return pis
...
def test_alignment_creation():
    ...
    print("\nâœ“ Alignment creation test PASSED")
...
def test_auto_update():
    ...
    print("\nâœ“ Auto-update test PASSED (manual interaction required)")
